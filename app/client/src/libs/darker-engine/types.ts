...
export type AddEntityProps<I, C extends string | number, D> = ActionConfig &
...
export type RemoveComponentProps<C> = ActionConfig &
  RemoveComponentProcessorProps<C>;
...
export type UpdateComponentProps<C, D, T extends keyof D> = ActionConfig &
...
export interface EngineType<I, C extends string | number, D> {
  ...
  addEntity: (
    config: AddEntityProps<I, C, D>,
  ) => Promise<number | EntityType<I, C, D>[]>;
...
export interface EntityType<I, C extends string | number, D> {
  ...
  removeComponent: (
    config: Omit<RemoveComponentProps<C>, "entityId">,
  ) => Promise<number | void>;
}
...
export type QueueAction<
  ...
  D,
  K extends ActionTypes = ActionTypes,
> = {
  id: number;
  type: K;
  priority?: Priority;
